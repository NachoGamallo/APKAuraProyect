...
import 'change_user_name_model.dart';
export 'change_user_name_model.dart';

class ChangeUserNameWidget extends StatefulWidget {
  const ChangeUserNameWidget({super.key});

  static String routeName = 'ChangeUserName';
  static String routePath = '/changeUserName';
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: FFAppState().actualUser.name,
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if ((_model.textController.text !=
                          ...
                          _model.resultName =
                              await ChangeUserDataGroup.updateUserNameCall.call(
                            name: _model.textController.text,
                            token: currentAuthenticationToken,
                          );

                          if ((_model.resultName?.succeeded ?? true)) {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('HECHO!'),
                                  content: Text(
                                      'Has actualizado el nombre con exito'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
