...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    aURAProyectAuthUserSubject.add(
      AURAProyectAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<AURAProyectAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  AURAProyectAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = AURAProyectAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    aURAProyectAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
AURAProyectAuthUser? currentUser;
