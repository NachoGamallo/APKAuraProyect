...
class Action2SheetSimpleWidget extends StatefulWidget {
  const Action2SheetSimpleWidget({
    super.key,
    required this.dataOfExercise,
    required this.dataToRemove,
  });

  final ExerciseSumaryStruct? dataOfExercise;
  final RoutineCreatorWithExerciseDataStruct? dataToRemove;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            FFButtonWidget(
              onPressed: () async {
                _model.apiExerciseDetails = await GetExerciseDetailsCall.call(
                  exerciseID: widget.dataOfExercise?.id,
